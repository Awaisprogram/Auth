...
function Contact() {
  ...
  <iframe
            ...
            title="map"
            scrolling="no"
            src="https://maps.google.com/maps?q=Karachi,+Pakistan&z=14&output=embed"
            style={{
  ...
  <div className="container px-5 py-24 mx-auto flex">
    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
      ...
      <button className="text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-gray-900 rounded text-lg">
        Button
      </button>
